...
alias torrents='cd /mnt/HDD-1/MY_STUFF/PC/Torrent_Files && c'
...
alias dw='nv /mnt/HDD-1/MY_STUFF/PC/Bash/Scripts/watch1.sh'
alias watch='bash /mnt/HDD-1/MY_STUFF/PC/Bash/Scripts/watch1.sh'

alias weba='nv /mnt/HDD-1/MY_STUFF/MISC/Vim/Web_Development.txt'
alias webb='cd /mnt/HDD-1/MY_STUFF/PC/Web_Development && c'
alias upwork='cd /mnt/HDD-1/MY_STUFF/MISC/Vim/Upwork && c'
alias back='(cd /mnt/HDD-1/MY_STUFF/PC/Dot_Files && rm -rf transmission Brave-Browser && cp -r ~/.config/transmission ~/.config/BraveSoftware/Brave-Browser . && cp /home/yann/.bashrc /home/yann/.bash_aliases .)'
alias brave='(xargs brave < /mnt/HDD-1/MY_STUFF/PC/Bash/Scripts/URLs.txt &>/dev/null && c)'
alias mullvad='(cd /mnt/HDD-1/MY_STUFF/PC/Softwares/mullvad-browser/ && ./start-mullvad-browser.desktop)'
alias social='(cd /mnt/HDD-1/MY_STUFF/PC/Softwares/mullvad-browser/Browser && xargs ./mullvadbrowser < /mnt/HDD-1/MY_STUFF/PC/Bash/Scripts/social.txt)'
alias send='(cd /mnt/HDD-1/MY_STUFF/PC/Softwares/ && ./LocalSend-1.10.0-linux-x86-64.AppImage)'
alias sync='(cd /mnt/HDD-1/MY_STUFF/PC/Softwares/syncthing-linux-amd64-v1.23.6 && ./syncthing && c)'
