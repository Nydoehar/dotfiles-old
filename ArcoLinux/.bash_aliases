...
alias back='(cd /mnt/HDD/MY_STUFF/PC/Dot_Files && rm -rf transmission Brave-Browser && cp -r ~/.config/transmission ~/.config/BraveSoftware/Brave-Browser . && cp /home/yann/.bashrc /home/yann/.bash_aliases .)'
alias brave='(xargs brave < /mnt/HDD/MY_STUFF/PC/Bash/Scripts/URLs.txt &>/dev/null && c)'
