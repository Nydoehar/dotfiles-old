...
alias pc='cd /mnt/HDD/MY_STUFF/TECHVAULT/ && c'
alias apps='cd /mnt/HDD/MY_STUFF/TECHVAULT/Apps/ && c'
...
alias dw='nv /mnt/HDD/MY_STUFF/TECHVAULT/Bash/Scripts/watch1.sh'
alias watch='bash /mnt/HDD/MY_STUFF/TECHVAULT/Bash/Scripts/watch1.sh'

alias weba='nv /mnt/HDD/MY_STUFF/MISC/Vim/Web_Development.txt'
alias webb='cd /mnt/HDD/MY_STUFF/TECHVAULT/Web_Development && c'
alias upwork='cd /mnt/HDD/MY_STUFF/MISC/Vim/Upwork && c'
alias back='(cd /mnt/HDD/MY_STUFF/TECHVAULT/Dot_Files && rm -rf transmission Brave-Browser && cp -r ~/.config/transmission ~/.config/BraveSoftware/Brave-Browser . && cp /home/yann/.bashrc /home/yann/.bash_aliases .)'
alias brave='(xargs brave < /mnt/HDD/MY_STUFF/TECHVAULT/Bash/Scripts/URLs.txt &>/dev/null && c)'
alias mullvad='(cd /mnt/HDD/MY_STUFF/TECHVAULT/Softwares/mullvad-browser/ && ./start-mullvad-browser.desktop)'
alias social='(cd /mnt/HDD/MY_STUFF/TECHVAULT/Softwares/mullvad-browser/Browser && xargs ./mullvadbrowser < /mnt/HDD/MY_STUFF/TECHVAULT/Bash/Scripts/social.txt)'
alias send='(cd /mnt/HDD/MY_STUFF/TECHVAULT/Softwares/ && ./LocalSend-1.10.0-linux-x86-64.AppImage)'
alias sync='(cd /mnt/HDD/MY_STUFF/TECHVAULT/Softwares/syncthing-linux-amd64-v1.23.6 && ./syncthing && c)'
alias freenet='(cd /mnt/HDD/MY_STUFF/TECHVAULT/Dark_Nets/Freenet && ./run.sh start)'
